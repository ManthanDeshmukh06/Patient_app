...
export default function PrescriptionsScreen() {
  const items = [
    { id: 1, doctor: 'Dr. Anjali Verma', date: 'Aug 21, 2025', meds: 'Amoxicillin 500mg • 5 days' },
    { id: 2, doctor: 'Dr. Rohit Mehta', date: 'Jul 12, 2025', meds: 'Cetirizine 10mg • 3 days' },
  ];
    ...
    <ScrollView style={styles.screen}>
      ...
      {items.map((p) => (
        <Card key={p.id}>
          ...
          <CustomButton title="Download PDF" style={{ marginTop: 10 }} onPress={() => {}} />
        </Card>
      ))}
    </ScrollView>
  );
