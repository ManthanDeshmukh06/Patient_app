...
export default function BillingScreen() {
  const bills = [
    { id: 1, title: 'Consultation - Dr. Verma', status: 'Paid', amount: '₹500', date: 'Aug 21, 2025' },
    { id: 2, title: 'Lab Test - CBC', status: 'Unpaid', amount: '₹700', date: 'Aug 22, 2025' },
  ];
  return (
    <ScrollView style={styles.screen}>
      ...
      {bills.map((b) => (
        <Card key={b.id}>
          ...
          <Text style={styles.meta}>💰 {b.amount} • {b.status}</Text>
          <CustomButton title="View Receipt" style={{ marginTop: 10 }} onPress={() => {}} />
        </Card>
      ))}
    </ScrollView>
  );
