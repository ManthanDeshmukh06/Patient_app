...
router.post(
  "/register-patient",
  isLoggedIn,
  appointmentsController.registerPatient
);
...
router.post(
  "/availability",
  isLoggedIn,
  appointmentsController.setDoctorAvailability
);
...
router.get(
  "/hospital/:hospitalId",
  isLoggedIn,
  appointmentsController.getAppointmentsByHospital
);

// Get doctor appointments by date
router.get(
  "/doctor/:doctorId/:date",
  appointmentsController.getDoctorAppointmentsByDate
);
